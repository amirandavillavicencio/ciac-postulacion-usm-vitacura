        ...
        <div className="relative mx-auto flex min-h-[72vh] max-w-7xl flex-col justify-center px-6 py-16 lg:px-10">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-base leading-7 text-slate-200 sm:text-lg">
              Plataforma para centralizar postulaciones, revisar disponibilidad
              horaria y apoyar la coordinación de tutores, ayudantes y funciones
              de apoyo del CIAC en Campus Vitacura.
            </p>
        ...
        <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
          <div className="rounded-3xl bg-white p-8 shadow-sm ring-1 ring-slate-200">
            ...
            <p className="mt-4 text-sm leading-7 text-slate-600 sm:text-base">
              Esta plataforma fue pensada para ordenar el proceso de postulación
              del CIAC, permitiendo reunir datos relevantes como carrera,
              disponibilidad, motivación y cargo de interés. Al mismo tiempo,
              entrega un punto de entrada claro para la revisión administrativa y
              futura asignación de horarios.
            </p>
